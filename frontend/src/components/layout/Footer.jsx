        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-background/70 max-w-xs">
              AI-powered job discovery platform that helps you find your dream job faster with intelligent matching and automation.
            </p>
            
            {/* Newsletter */}
            <div className="space-y-3">
              <h4 className="font-semibold text-background">Subscribe to our newsletter</h4>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-background/60">
            © {currentYear} GrowShell. All rights reserved.
          </p>
